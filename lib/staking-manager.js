...
import EverscaleConfigParams from './everscale-config-params.js';
import StakingManagementPolicy from './modern-smp.js';
import * as config from '../config.js';

TonClient.useBinaryLibrary(libNode);

export default class StakingManager extends StakingManagementPolicy {
