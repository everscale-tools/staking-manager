...
// const abiElector = loadJSON('../contracts/solidity/elector/Elector.abi.json');

const debug = Debug('lib:modern-smp');
...
export default class ModernStakingManagementPolicy extends StakingManagementPolicy {
    constructor(client, ...args) {
        super(client, ...args);

        this.client = client;
        /*
        this.runTVMQueue = Async.queue((params, cb) => {
    ...
    */
    ...
    async sendMessageViaConsole(message_encode_params) {
        ...
        fs.writeFileSync(path, message, 'base64');
